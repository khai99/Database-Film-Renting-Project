    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Your Other Unpaid Payments</h1>
          ...
          <div class="card shadow mb-4">
			...
			<?php
				...
				$mysqls = "SELECT film.title, payment_type.name, payment.payment_id, payment.amount, payment.payment_date FROM payment INNER JOIN payment_type ON payment.payment_type_id = payment_type.payment_type_id INNER JOIN rental ON payment.rental_id = rental.rental_id INNER JOIN inventory ON rental.inventory_id = inventory.inventory_id INNER JOIN film ON inventory.film_id = film.film_id WHERE payment.customer_id = (SELECT customer.customer_id FROM customer WHERE customer.email = '$email') && payment.payment_type_id <>1 && payment.payment_status = 0 && payment.payment_date IS NULL";
				$links = mysqli_connect('localhost','hfycb1_hfycb1','12345isint.','hfycb1_id13307643_assignment2') or die("Could not connect to database");
								...
								while($row = mysqli_fetch_assoc($result)){
									...
									echo("<td>
										<form action = 'payment.php' method = 'post'>
											<input style = 'display:none;' value = '$payment_id'type = 'text' name = 'payment_id' />
									...
									<td>
										<form action = 'customer_payment_detail.php' method = 'post'>
											<input style = 'display:none;' value = '$payment_id'type = 'text' name = 'other_unpaid' />
