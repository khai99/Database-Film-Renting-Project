    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800">View Rental ID :  <span style = "color:#e15d44;"><?php echo $rentalIDV;  ?></span></h1>
              ...
              <div class="card position-relative">
                <div class="card-header py-3">
				 <div class="text-center">
                  <h6 class="m-0 font-weight-bold text-primary">View the rental cancelled details</h6>
				  </div>
                </div>
                <div class="card-body">
				<p id = "sameVal" class = "errorMessage"></p>
                    ...
                    <span style = "color:#e15d44;"><i><?php echo $viewRental['last_update']; ?></i></span>
				...
				<div class="form-group">
					...
					$sqlGetC = "SELECT rental.customer_id, customer.email FROM `rental` INNER JOIN `customer` ON rental.customer_id = customer.customer_id WHERE rental_id = '$rentalIDV'";
                   ...
                   <div class="form-group">
					<span style = "color:black;"><b>Inventory details: </b></span>
					<span style = "color:black;"><i><?php
									$selectVal = "SELECT rental.inventory_id, film.title FROM `rental` INNER JOIN `inventory` ON rental.inventory_id = inventory.inventory_id INNER JOIN `film` ON inventory.film_id = film.film_id WHERE rental.rental_id = '$rentalIDV'";
									$run = mysqli_query($links,$selectVal);
									$runner = mysqli_fetch_assoc($run);
									if(empty($runner['inventory_id'])){
										echo '-';
									}else{
					echo $runner['inventory_id']; echo '-'; echo $runner['title']; 
									}?></i></span>
				...
				<div class="form-group">
					...
					<span style = "color:black;"><i><?php 
					  ...
					  if(empty( $viewRental['rental_date'])){
						  echo '-';
					  }else{
					echo $viewRental['rental_date']; 
					...
					<span style = "color:black;"><i><?php 
					 ...
					 if(empty( $viewRental['return_date'])){
						 echo '-';
					 }else{
						echo $viewRental['return_date']; 
					 }
					?></i></span>
				...
				<div class="form-group">
					...
					<span style = "color:black;"><i><?php echo $viewRental['staff_id']; echo '-'; echo $viewRental['first_name']; echo '&nbsp'; echo $viewRental['last_name']; ?></i></span>
                    
                </div>
				
				<div class="form-group">
					<span style = "color:black;"><b>Status ID: </b></span>
					<span style = "color:black;"><i><?php echo $viewRental['status_id']; echo '-'; echo $viewRental['status_name']; ?></i></span>
				  ...
				  <br/>
				  <?php if (isset($rentalIDV)){ 
				  echo("<a  class='btn btn-danger btn-user' href='view_rental_cancelled.php'>Back</a>");
				   } ?>
              </div>
