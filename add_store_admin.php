    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Add New Store</h1>
		  <p>Here you can add new store</p>
		  <a href = 'admin_store.php'><p class = 'btn btn-primary'>Back to Store Table</p></a>
			<div class = "row"
              ...
              <div class="card shadow mb-4" style = "width:1000px;">
                ...
                <div class="card-body">
					<?php
						...
						{
							echo("<p style = 'font-size:17px;color:#1cc88a'>Successfully added store!</p>");
				  ...
				  <form method = 'post' action = 'add_store_check.php'>
					<?php
						echo("<p><span style = 'font-size:17px;'><b>Store Address: </b></span></p>");
						echo("<input name = 'address'required minlength='6' maxlength='50' pattern='[^\s][A-Za-z0-9 , \s]+'class = 'form-control form-control-user'type = 'text'  title = 'Store Address'/>");
						echo("<p><span style = 'font-size:17px;'><b>Store Address 2: (Optional)</b></span></p>");
						echo("<input name = 'address2' minlength='6' maxlength='50' pattern='[^\s][A-Za-z0-9 , \s]+'class = 'form-control form-control-user'type = 'text'  title = 'Store Address 2 (Optional)'/>");
						echo("<p><span style = 'font-size:17px;'><b>Store Distict: </b></span></p>");
						echo("<input name = 'district'minlength='4' maxlength='20' pattern='[^\s][A-Za-z0-9 , \s]+' required class = 'form-control form-control-user'type = 'text'  title = 'Store District'/>");
						echo("<p><span style = 'font-size:17px;'><b>Postal Code: (Optional)</b></span></p>");
						echo("<input name = 'postal_code'minlength='4' maxlength='10' pattern='[0-9]+' class = 'form-control form-control-user'type = 'text'  title = 'Postal Code (Optional)'/>");
						echo("<p><span style = 'font-size:17px;'><b>Store Phone: (Optional)</b></span></p>");
						echo("<input name = 'phone'minlength = '6' pattern='[0-9]+' class = 'form-control form-control-user'type = 'text'  title = 'Store Phone (Optional)'/>");
						  ...
						  // $city = $cus_details['city'];
						   ...
						   while($row = mysqli_fetch_assoc($result2)){
							   ...
							   $city2 = $row['city'];
								...
								echo "<option value='$city_id2' >$city2</option>";
					...
					<?php
						$sqli = "SELECT staff.first_name,staff.last_name,staff.staff_id FROM staff WHERE staff.staff_id NOT IN (SELECT store.manager_staff_id FROM store WHERE 1)AND staff.staff_id <>3 AND staff.staff_id <>4 AND staff.active = 1";
						$result2 = mysqli_query($links, $sqli);
						$message_here = "Pick a Staff";
						$show = 0;
						if(mysqli_num_rows($result2)==0)
						{
							$message_here = "No Available Staff";
							$show = 1;
						}
						echo("<select autocomplete = 'off' required = 'required' title = 'Each store must have at least 1 staff.' name = 'staff_id' id='list'  placeholder='$message_here'>	 ");
					?>
						  ...
						  // $city = $cus_details['city'];
						   ...
						   if(mysqli_num_rows($result2)!=0)
						   {
							   while($row = mysqli_fetch_assoc($result2)){
									...
									echo "<option value='$row[staff_id]'  >$staff_name</option>";
					...
					<b><p style = 'color:red;'>If you do not see any staff here, add at least 1 staff to add a new store. Each stire must have at least 1 staff.</p></b>
					<?php
						if($show == 1)
						{
							echo("<a href = 'staff_add.php'><input type = 'button' value = 'Go to Add New Staff' title = 'Go to Add New Staff'  class = 'btn btn-primary'/></a>");
						}
					?>
					<input class = 'btn btn-primary'type = 'submit' value = 'Add Store' title ='Add Store' style = 'float:right;'/>
