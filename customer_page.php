...
<body id="page-top">
	<?php
		...
		$sql1 = "SELECT address.phone,address.address,address.address2,address.district,address.postal_code,city.city,customer.email,customer.customer_id, customer.first_name, customer.last_name, customer.password FROM customer Inner JOIN address ON customer.address_id = address.address_id INNER JOIN city ON address.city_id =city.city_id WHERE customer.email = '$emails'";
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
				  ...
				  ?>
				  <form action = "customer_personal_info_check.php" method = "post"style = "margin-bottom:17%">
					
					<h6 class="font-weight-bold" >Customer ID: <i style = "margin-left:20px;"class = "fas fa-question-circle" title = "Customer ID helps uniquely identifies each customer and cannot be modified"></i></h6>
					<?php
						
						$cus_id = $cus_details['customer_id'];
					...
					<p style = "color:#36b9cc;font-size:13px;">Please provide your <i>Customer ID</i> when contacting us. Thanks!</p>
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4" >
                ...
                <div class="card-body">
				  ...
				  ?>
				  <form action = "customer_contact_check.php" method = "post" >
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Movyes 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
