...
<link rel = "shortcut icon" href = "img/fav.png" />
  ...
  <script>
    ...
    {
      var x = confirm("Are you sure that Customer has Paid for the Film");
      if (x)
          return true;
      else
        return false;
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Rental Payment</h6>
            </div>
            <div class="card-body">
			<?php  
			   if(isset($_SESSION['payment_message'])){ ?>
				   <div class="alert alert-<?=$_SESSION['msg_typeP']?>"> 
				   
			   <?php  
			     echo $_SESSION['payment_message'];
				 unset($_SESSION['payment_message']);          //<?= mean just show cut echo
