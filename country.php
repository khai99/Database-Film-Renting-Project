...
<link rel = "shortcut icon" href = "img/fav.png" />
  ...
  <style>
   ...
   <script>
     function errorCountryN($value){
		 
		 if($value == 1){
		 document.getElementById("countryError").innerHTML="Invalid input: Duplicate country name found";
		 }else{
...
<li class="nav-item">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Add new country details</h1>
          ...
          <div class="row">
            ...
            <div class="col-lg-7">
             ...
             <div class="card shadow mb-4">
                ...
                <div class="card-body">
				<p id = "countryError" class = "errorMessage"></p>
				
                 <form action = "country_insert.php" method = "post">
                <div class="form-group row">
                  <div class="col-sm-8 mb-6 mb-sm-0">
				  <span style="color:black";><i>Country Name:</i></span>
                    <input type="text" class="form-control form-control-user" name="countryName" minlength = "2" title = "Characters only and minimum length is 2" pattern="[^\s][A-Za-z\s]+" maxlength="50" required="required" id="countryName" placeholder="Country Name" value = "<?php if (isset($_POST['backCountryname'])){echo $_POST['backCountryname'];} ?>">
				 ...
				 <button  name = "submitLanguage"  type="submit" class="btn btn-primary btn-icon-split btn-sm"><span class="icon text-white-50">
                  ...
                  <span class = "text">Add country</span></button>
                 </form>
                </div>
              </div>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   ...
   <?php 
			     ...
			     if(isset($_POST['inside_Country'])){
					 echo ("<script>errorCountryN(1);</script>");
				 }
			     else{
					 
					 echo ("<script>errorCountryN(0);</script>");
				 }
