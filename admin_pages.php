    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Admin Pages</h1>
		  <p>Here you can access pages that are only accessible by Admins</p>
            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h5 class="m-0 font-weight-bold text-primary">Store Pages</h5>
                </div>
                <div class="card-body">
                  <a href = 'add_store_admin.php'><p class = 'btn-primary btn'>Add New Store</p></a>
				  <br />
				  <a href = 'admin_store.php'><p class = 'btn-primary btn'>Store Pages</p></a>
				  <br />
				  <p>In Store Page, you can view, update, edit store and many more.</p>
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h5 class="m-0 font-weight-bold text-primary">Staff Pages</h5>
                </div>
                <div class="card-body">
				  <a href = 'staff_add.php'><p class = 'btn-primary btn'>Add New Staff</p></a>
				  <br />
				  <a href = 'admin_staff.php'><p class = 'btn-primary btn'>Staff Pages</p></a>
				  <br />
				   <p>In Staff Page, you can view, update, edit staff and many more.</p>
