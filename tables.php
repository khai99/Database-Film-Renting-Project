        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Films details</h6>
            </div>
            <div class="card-body">
			<?php  
			   ...
			   <?php  
				 ...
				 unset($_SESSION['message']);          //<?= mean just show cut echo
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="90%" cellspacing="0">
                  ...
                  <tbody>
                    <?php 
					     $sql = "SELECT film.film_id,film.title,film.release_year,language.name,film.rental_duration,film.rental_rate,film.length, film.replacement_cost,film.rating,film.last_update FROM `film` INNER JOIN `language` ON film.language_id = language.language_id";
					...
					<tr>
					  ...
					  <td><?php echo $row['title']; ?></td>
					   ...
					   <form action = "tables_update.php" method = "post">
					  <td>
							<button  name = "editButton" id = "editButton" value = "<?php echo $row['film_id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Edit</button> 
							
						</td>
						</form>
						
						<form action = "confirm_delete_film.php" method = "post"> 
					<td><button Onclick="return ConfirmDelete();" type = "submit" name = "deleteButton" id = "deleteButton"  value = "<?php echo $row['film_id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="glyphicon glyphicon-edit"></span> Delete</button> </td>
					</form>
					</tr>
					<?php
				}
