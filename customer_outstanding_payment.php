...
<head>
  ...
  <title>Customer - Outstanding Payment</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h5 class="m-0 font-weight-bold text-primary">Your Outstanding Payment Records</h5>
            </div>
			<?php
				$email = $_SESSION['email'];
				$mysqls = "SELECT payment.payment_id, film.title, category.name,payment.amount FROM payment INNER JOIN rental ON payment.rental_id = rental.rental_id INNER JOIN inventory ON rental.inventory_id = inventory.inventory_id INNER JOIN film ON inventory.film_id = film.film_id INNER JOIN film_category ON film.film_id = film_category.film_id INNER JOIN category ON film_category.category_id = category.category_id WHERE payment.customer_id = (SELECT customer.customer_id FROM customer WHERE customer.email = '$email')&&payment.payment_status = 0 && payment.payment_type_id = 1 && payment.payment_date IS NULL";
				$links = mysqli_connect('localhost','hfycb1_hfycb1','12345isint.','hfycb1_id13307643_assignment2') or die("Could not connect to database");
            ...
            <div class="card-body">
              <div class="table-responsive">
				<?php
					...
					{
						echo("<p style = 'color:#1cc88a'>Successfully made payment!</p>");
					}
				?>
								...
								while($row = mysqli_fetch_assoc($result)){
									...
									echo("<td>
										<form action = 'payment.php' method = 'post'>
											<input style = 'display:none;' value = '$payment_id'type = 'text' name = 'payment_id_out' />
									...
									<td>
										<form action = 'customer_payment_detail.php' method = 'post'>
											<input style = 'display:none;' value = '$payment_id'type = 'text' name = 'out_pay' />
