...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.6/css/selectize.bootstrap3.min.css" integrity="sha256-ze/OEYGcFbPRmvCnrSeKbRTtjG4vGLHXgOqsyLFTRjg=" crossorigin="anonymous" />
  ...
  <style>
   ...
   <script>
     function errorInven($value){
		 
		 if($value == 1){
		 document.getElementById("errorInven1").innerHTML="Invalid insert: value cannot be inserted";
		 }else{
			 
			 document.getElementById("errorInven1").innerHTML="";
		 }
...
<li class="nav-item">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Add new inventory details</h1>
            ...
            <div class="col-lg-9">
             ...
             <div class="card shadow mb-4">
                <div class="card-header py-3">
                  ...
                  <h6 class="m-0 font-weight-bold text-primary">Add new inventory movie</h6>
                </div>
                <div class="card-body">
				<p id = "errorInven1" class = "errorMessage"></p>
				
                 <form action = "inventory_insert.php" method = "post">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
				   <span style = "color:black;"><b>Choose a Film: </b></span>
                     <select autocomplete = "off" required = "required" name = "filmS" id="filmS"  placeholder="" >
					
						 
						 <?php
						   echo "<option value = ''>-- Select a film--</option>";
						   $sqli = "SELECT film_id,title FROM `film` WHERE 1 ORDER BY film_id ASC";
						   $result2 = mysqli_query($links, $sqli);
						   
						   while($row = mysqli_fetch_assoc($result2)){
							   
							   $selected = (isset($_POST['backFilm']) && $_POST['backFilm'] ==  $row['film_id']) ? 'selected' : '';
				   ...
				   <span style = "color:black;"><b>Choose a store: </b></span>
                     <select autocomplete = "off"  name = "storeIn"  id="storeIn" required = "required"  placeholder="" >
					     <?php
						   ...
						   while($rowS = mysqli_fetch_assoc($resultStore)){
							 ...
							 $selectedS = (isset($_POST['backStore']) && $_POST['backStore'] ==  $rowS['store_id']) ? 'selected' : '';
				 ...
				 <button  name = "submitTitle"  type="submit" class="btn btn-primary btn-icon-split btn-sm"><span class="icon text-white-50">
                  ...
                  <span class = "text">Add to inventory</span></button>
                 </form>
                </div>
              </div>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   ...
   <?php 
			     ...
			     if(isset($_POST['inside_Inven'])){
					 echo ("<script>errorInven(1);</script>");
				 }
			     else{
					 
					 echo ("<script>errorInven(0);</script>");
				 }
