...
<link rel = "shortcut icon" href = "img/fav.png" />
  ...
  <script>
    function ConfirmCustomerReceived()
    {
	...
	function ConfirmCustomerReturned()
    {
      var x = confirm("Are you sure that Customer Returned the Film");
      if (x)
          return true;
      else
        return false;
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Online Rental Process</h6>
            </div>
            <div class="card-body">
			<?php  
			   ...
			   <?php  
			     echo $_SESSION['su_message'];
				 unset($_SESSION['su_message']);          //<?= mean just show cut echo
                ...
                <table class="table table-bordered" id="dataTable" width="90%" cellspacing="0">
                  ...
                  <tbody>
                    <?php 
						...
						$sqlRenOn = "SELECT * FROM `rental` WHERE rental_date IS NULL AND status_id = '2'";
					...
					<tr>
					  ...
					  ?></td>
					   ...
					   <form action = "handle_online_received.php" method = "post">
					  <td>
							<button Onclick="return ConfirmCustomerReceived();"  name = "custReceivedButton" id = "custReceivedButton" value = "<?php echo $row['rental_id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span>Customer Received</button> 
