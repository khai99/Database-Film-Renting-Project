...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.6/css/selectize.bootstrap3.min.css" integrity="sha256-ze/OEYGcFbPRmvCnrSeKbRTtjG4vGLHXgOqsyLFTRjg=" crossorigin="anonymous" />
  ...
  <style>
   ...
   <script>
     function dupCity($value){
		 
		 if($value == 1){
		 document.getElementById("dupCityName").innerHTML="Invalid input: Duplicate city name found";
		 }else{
			 
			 document.getElementById("dupCityName").innerHTML="";
		 }
		 
	 }
	  function cityNotIn($value){
		 
		 if($value == 1){
		 document.getElementById("cityError").innerHTML="Invalid insert: unable to add the new city";
		 }else{
...
<li class="nav-item">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Add new city details</h1>
          ...
          <div class="row">
            ...
            <div class="col-lg-7">
             ...
             <div class="card shadow mb-4">
                ...
                <div class="card-body">
				<p id = "dupCityName" class = "errorMessage"></p>
				<p id = "cityError" class = "errorMessage"></p>
                 <form action = "city_insert.php" method = "post">
                <div class="form-group">
               
				  <span style="color:black";><i><b>City Name:</b></i></span>
                    <input type="text" class="form-control form-control-user" name="cityName" minlength = "2" title = "Characters only and minimum length is 2" pattern="[^\s][A-Za-z()\s]+" maxlength="50" required="required" id="cityName" placeholder="City Name" value = "<?php if (isset($_POST['backCityname'])){echo $_POST['backCityname'];} ?>">
				
             
                </div>
				<div class="form-group">
				   <span style = "color:black;"><b>Country that associated with the city: </b></span>
                     <select  autocomplete = "off"  name = "countrySelected"  id="countrySelected" required = "required"  placeholder="" >
					     <?php
						   echo "<option value = ''>-- Select Country--</option>";
						   $sqli = "SELECT * FROM `country` WHERE 1";
						   $resultAct = mysqli_query($links, $sqli);
						    while($row = mysqli_fetch_assoc($resultAct)){
							   
							   $selected = (isset($_POST['backCountryID']) && $_POST['backCountryID'] ==  $row['country_id']) ? 'selected' : '';
				 ...
				 <button  name = "submitLanguage"  type="submit" class="btn btn-primary btn-icon-split btn-sm"><span class="icon text-white-50">
                  ...
                  <span class = "text">Add city</span></button>
                 </form>
                </div>
              </div>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   ...
   <?php 
			     ...
			     if(isset($_POST['duplicateCity'])){
					 echo ("<script>dupCity(1);</script>");
				 }
			     else{
					 
					 echo ("<script>dupCity(0);</script>");
				 }
				 
				 
				    
			     if(isset($_POST['errorCity'])){
					 echo ("<script>cityNotIn(1);</script>");
				 }
			     else{
					 
					 echo ("<script>cityNotIn(0);</script>");
				 }
