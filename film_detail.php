...
<link rel = "shortcut icon" href = "img/fav.png" />
  ...
  <style>
   ...
   <script>
     function errorLan($value){
		 
		 if($value == 1){
		 document.getElementById("errorLanguage1").innerHTML="Invalid input: Duplicate name found";
		 }else{
			 
			 document.getElementById("errorLanguage1").innerHTML="";
		 }
		 
	 }
    
	function errorActor($value){
		if($value == 1){
			document.getElementById("errorActorName").innerHTML="Invalid input: Duplicate actor name found";
		}else{
			 
			 document.getElementById("errorActorName").innerHTML="";
		 }
	}
	
	function errorCategory($value){
		if($value == 1){
			document.getElementById("errorCategoryName").innerHTML="Invalid input: Duplicate category name found";
		}else{
...
<li class="nav-item">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Add new film details</h1>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
             ...
             <div class="card shadow mb-4">
                ...
                <div class="card-body">
				<p id = "errorLanguage1" class = "errorMessage"></p>
				
                 <form action = "check_language.php" method = "post">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="languName" minlength = "3" title = "Characters only and minimum length is 3" pattern="[^\s][A-Za-z\s]+" maxlength="20" required="required" id="languName" placeholder="Language Name" value = "<?php if (isset($_POST['backLanName'])){echo $_POST['backLanName'];} ?>">
					
                  </div>
             
                </div>
				 <button  name = "submitLanguage"  type="submit" class="btn btn-primary btn-icon-split btn-sm"><span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                  <span class = "text">Add language</span></button>
                 </form>
                </div>
              </div>
			  
				
              <!-- Brand Buttons -->     <!-- First name and last name must not be same at the same time-->
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                ...
                <div class="card-body">
					<p id = "errorActorName" class = "errorMessage"></p>
                 <form action = "check_actor.php" method = "post" >
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="fName" minlength = "2" title = "Characters only and minimum length is 2" pattern="[^\s][A-Za-z\s]+" maxlength="45" required="required" id="fName" placeholder="First Name" value = "<?php if (isset($_POST['backActorFname'])){echo $_POST['backActorFname'];} ?>">
					
                  </div>
                     <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" maxlength="45" minlength = "3" title = "Characters only and minimum length is 3"  pattern="[^\s][A-Za-z\s]+" name = "lName"  id="lName" required="required" placeholder="Last Name" value = "<?php if (isset($_POST['backActorLname'])){echo $_POST['backActorLname'];} ?>">
				 ...
				 <button  name = "submitLanguage"  type="submit" class="btn btn-primary btn-icon-split btn-sm"><span class="icon text-white-50">
                  ...
                  <span class = "text">Add actor</span></button>
                 </form>
            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
				<p id = "errorCategoryName" class = "errorMessage"></p>
                   <form action = "check_category.php" method = "post" >
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="cateName" minlength = "3" title = "Characters only and minimum length is 3" pattern="[^\s][A-Za-z\s]+" maxlength="25" required="required" id="cateName" placeholder="Category Name" value= "<?php if (isset($_POST['backCateName'])){echo $_POST['backCateName'];} ?>">
					
                  </div>
             
                </div>
				 <button  name = "submitLanguage"  type="submit" value = "submitLanguage" class="btn btn-primary btn-icon-split btn-sm"><span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                  <span class = "text">Add category</span></button>
                 </form>
                </div>
              </div>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   ...
   <?php 
			     ...
			     if(isset($_POST['inside_Lan'])){
					 echo ("<script>errorLan(1);</script>");
				 }
			     else{
					 
					 echo ("<script>errorLan(0);</script>");
				 }
				 
				  if(isset($_POST['inside_Actor'])){
					 echo ("<script>errorActor(1);</script>");
				 }
			     else{
					 
					 echo ("<script>errorActor(0);</script>");
				 }
				 
				   if(isset($_POST['inside_Category'])){
					 echo ("<script>errorCategory(1);</script>");
				 }
			     else{
					 
					 echo ("<script>errorCategory(0);</script>");
				 }
